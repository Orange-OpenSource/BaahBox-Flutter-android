...
class CloudManager extends PositionComponent with HasGameReference<SheepGame> {
  ...
  void addCloud() {
    final cloudPosition = Vector2(
      game.size.x,
      (game.floorY - (Cloud.maxSkyLevel - Cloud.minSkyLevel)
