...
class BalloonComponent extends SpriteComponent with HasGameRef<BalloonGame> {
  ...
  final balloonstartSprite =
      Sprite(Flame.images.fromCache('Games/Balloon/ballon_00@2x.png'));
  final balloonlowSprite =
      Sprite(Flame.images.fromCache('Games/Balloon/ballon_01@2x.png'));
  final balloonmediumSprite =
      Sprite(Flame.images.fromCache('Games/Balloon/ballon_02@2x.png'));
  final balloonhighSprite =
      Sprite(Flame.images.fromCache('Games/Balloon/ballon_03@2x.png'));
